      ...
      <div class="card-body">
        <form action="service">
          ...
          <div class="row mb-4">
            ...
            <div class="col">
              <div class="form-outline">
                <input type="text" id="" class="form-control" name="pickup"/>
                <label class="form-label" for="form7Example1">pick up</label>
              </div>
            </div>
            <div class="col">
              <div class="form-outline">
                <input type="text" id="drop" class="form-control" onchange="summery()" name="droploc"/>
          ...
          <!-- Email input -->
          <div class="form-outline mb-4">
            <input type="email" id="email" class="form-control" onchange="summery()" name="email"/>
