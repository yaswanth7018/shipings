        ...
        <div class="card-body">
            ...
            <article class="card">
                <div class="card-body row">
                    <div class="col"> <strong>Estimated Delivery time:</strong> <br>27-07-2023</div>
                    <div class="col"> <strong>Shipping BY:</strong> <br> CARRYTO | <i class="fa fa-phone"></i> +919392381585 </div>
                    <div class="col"> <strong>Status:</strong> <br> Picked by the courier </div>
                    <div class="col"> <strong>Tracking #:</strong> <br> CARRYTO <%=data.get(5) %> </div>
                </div>
            </article>
            <div class="track">
